const CACHE='necati-cepte-v5.4';
const CORE=['./','./index.html','./style-v54.css','./app-v54.js','./cloud-v54.js','./firebase-config-v54.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
...
self.addEventListener('fetch', event => {
  ...
  if(same && (event.request.mode==='navigate' || /(?:app-v54|cloud-v54|firebase-config-v54|style-v54|index\.html)/.test(url.pathname))){
    event.respondWith(
...
try{
  ...
  importScripts('./firebase-config-v54.js');
